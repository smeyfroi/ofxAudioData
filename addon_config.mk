...
meta:
	ADDON_NAME = ofxAudioData
	ADDON_DESCRIPTION = Preprocess data from ofxAudioAnalysisClient
	ADDON_AUTHOR = @smeyfroi
	ADDON_TAGS = "addon"
	ADDON_URL = http://github.com/smeyfroi/ofxAudioData

common:
	# dependencies with other addons, a list of them separated by spaces 
	# or use += in several lines
	ADDON_DEPENDENCIES = ofxAudioAnalysisClient ofxHistoryPlot
